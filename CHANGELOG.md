...
### Changed
- fix: update repository URLs in package.json to reflect correct GitHub path

## [v1.2.1] - 2026-04-25

### Changed
- chore: remove prepublishOnly script from package.json

## [v1.2.0] - 2026-04-24

### Changed
- feat: update package.json with release and clean scripts
